...
def convert_range_image_to_point_cloud_flow(
    ...
    for c in calibrations:
        # print("range_images_flow keys:", range_images_flow.keys(), "current c.name:", c.name)
        # # 检查当前 key 是否存在
        # if c.name not in range_images_flow:
        #     print(f"Warning: range_images_flow does not have key {c.name}, skip this channel.")
        #     continue
